...
func generateTelegramSection(content *strings.Builder, cmd *cobra.Command) {
	...
	fmt.Fprintf(content, "%s=%s                           # 👍 reactions to bypass admin approval, "+
...
func generateAppShadowQueueSection(content *strings.Builder, cmd *cobra.Command) {
	...
	fmt.Fprintf(content, "%s=30     # Maintenance interval in seconds (CLI uses minutes!) (default: from %s mins)\n",
